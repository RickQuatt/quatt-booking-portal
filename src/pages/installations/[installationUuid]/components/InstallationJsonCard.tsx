...
export interface InstallationJsonCardProps {
  installation: AdminInstallationDetail;
}

/**
 * Bottom sidebar card displaying complete Installation JSON data
 * Uses react-json-view for interactive JSON exploration
 */
export function InstallationJsonCard({
  installation,
}: InstallationJsonCardProps) {
  return (
